...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, sharp corners, boxrule=0pt, breakable, colback={codebgcolor}, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\href{https://github.com/inlabru-courses/NewCaledonia2026/discussions}{course
...
\begin{verbatim}
Time used:
    Pre = 0.942, Running = 0.186, Post = 0.00853, Total = 1.14 
Fixed effects:
              mean    sd 0.025quant 0.5quant 0.975quant   mode kld
(Intercept) 10.061 0.099      9.865   10.061     10.256 10.061   0

Model hyperparameters:
                                        mean    sd 0.025quant 0.5quant
Precision for the Gaussian observations 1.03 0.144      0.764     1.02
                                        0.975quant mode
Precision for the Gaussian observations       1.33 1.01

Marginal log-Likelihood:  -153.39 
 is computed 
...
Time used:
    Pre = 0.891, Running = 0.195, Post = 0.0127, Total = 1.1 
Fixed effects:
            mean    sd 0.025quant 0.5quant 0.975quant   mode kld
Intercept 10.061 0.099      9.865   10.061     10.256 10.061   0
...
Marginal log-Likelihood:  -157.85 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
