...
\begin{verbatim}
Time used:
    Pre = 0.412, Running = 0.24, Post = 0.0449, Total = 0.697 
Fixed effects:
             mean    sd 0.025quant 0.5quant 0.975quant  mode kld
(Intercept) 9.723 0.093      9.541    9.723      9.906 9.723   0

Model hyperparameters:
                                        mean    sd 0.025quant 0.5quant
Precision for the Gaussian observations 1.18 0.166      0.878     1.17
                                        0.975quant mode
Precision for the Gaussian observations       1.53 1.16

Marginal log-Likelihood:  -146.35 
 is computed 
...
Time used:
    Pre = 0.302, Running = 0.23, Post = 0.0719, Total = 0.605 
Fixed effects:
           mean    sd 0.025quant 0.5quant 0.975quant  mode kld
Intercept 9.723 0.093      9.541    9.723      9.906 9.723   0
...
Marginal log-Likelihood:  -150.81 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
